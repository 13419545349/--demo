	...
	<div class="sales-board">
		...
		<div class="sales-board-form">
			...
			<div class="sales-board-line">
				...
				<div class="sales-board-line-right">
					<button>半年</button>   <button>一年</button>   <button>三年</button>
				</div>
			</div>
			<div class="sales-board-line">
				<div class="sales-board-line-left">
				...
				<div class="sales-board-line-right">
					<button>客户半</button>   <button>代理商版</button>   <button>专家版</button>
				</div>
			</div>
			<div class="sales-board-line">
				<div class="sales-board-line-left">
		...
		<my-dialog :is-show="isShowPayDialog" @on-close="hidePayDialog">
			<table class="buy-dialog-table">
				...
				<tr>
					...
					<td>{{buyType.label}}</td>
					<td>{{period.label}}</td>
					<td><span v-for="item in versions">{{item.label}}</span></td>
					<td>{{price}}</td>
				</tr>
			</table>
